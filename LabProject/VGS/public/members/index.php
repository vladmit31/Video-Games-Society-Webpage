          ...
          <?php $bansRe =  find_member_ban($member['Member_ID']); 
                while($ban = mysqli_fetch_assoc($bansRe)){
                 ...
                 ?>  
                    ...
                    <a class="btn btn-primary" href="<?php echo url_for('./members/editBan.php?id=' . h(u($ban['Ban_ID']))); ?>">Edit</a> 
                    <a class="btn btn-primary" href="<?php echo url_for('./members/deleteBan.php?id=' . h(u($ban['Ban_ID']))); ?>">Delete</a> 
