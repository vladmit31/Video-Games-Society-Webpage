    ...
    while($staff = mysqli_fetch_assoc($result)){ ?>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div>
                <a class="btn btn-primary" href="<?php echo url_for('./staff/edit.php?id=' . h(u($staff['Staff_ID']))); ?>">Edit</a> 
                <a class="btn btn-primary" href="<?php echo url_for('./staff/delete.php?id=' . h(u($staff['Staff_ID']))); ?>">Delete</a> 
