    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <a class="btn btn-primary"
               href="<?php echo url_for('./rentals/edit.php?id=' . h(u($rental['Rental_ID']))); ?>">Edit</a>
            <a class="btn btn-primary"
               href="<?php echo url_for('./rentals/delete.php?id=' . h(u($rental['Rental_ID']))); ?>">Delete</a>
            <a class="btn btn-primary"
               href="<?php echo url_for('./rentals/newBan.php?id=' . h(u($rental['Rental_ID']))); ?>">Ban</a>
        </div>
    </div>
